...
class Jasa extends CI_Controller {
    ...
    function index(){
		...
		$data['data_detail_jasa']=$this->m_admin->ambil_data('detail_jasa'); //parameter : namatabel,primary,id
		...
		// echo json_encode($data['data_jasa']);
		// exit;
	...
	function edit($id){
		...
		if ($this->form_validation->run() === FALSE){
        	...
        	if($this->m_admin->edit_data('jasa',$data_lain))
			{
				$data['content'] = "pesan";
				$data['page']='pesan';
