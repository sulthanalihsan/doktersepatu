  ...
  <div class="card shadow mb-4">
    ...
    <?php
        echo form_open_multipart('admin/akun/tambah');
    ?>
    ...
    <!-- <form action='#' > -->
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="email" name="email_adm" class="form-control" id="email_adm" placeholder="Masukan Data Email">
            </div>    
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" name="nama_adm" class="form-control" id="nama_adm" placeholder="Masukan Nama Admin">
            </div>
        </div>
        <div class="form-row">
